object fdataarincomingpayment: Tfdataarincomingpayment
  Left = 0
  Top = 0
  Caption = 'fdataarincomingpayment'
  ClientHeight = 528
  ClientWidth = 1148
  Color = clWhite
  ...
  object qdata: TUniQuery
    ...
    SQL.Strings = (
        ...
        'SELECT dt.tanggal,dt.customer_code_sap,dt.nama,dt.jml AS jmlknit' +
        'to,IFNULL(ds.jml,0) AS jmlsap,(dt.jml - IFNULL(ds.jml,0)) AS sel' +
        'isih'
      
        'FROM (SELECT DATE(dk.tanggal_transfer) AS tanggal,c.customer_cod' +
        'e_sap,c.`nama`,SUM(dk.jumlah_uang) AS jml'
      ...
      'GROUP BY tanggal,customer_code_sap) ds  '
        ...
        'de_sap '
      'WHERE (dt.jml - IFNULL(ds.jml,0)) !=0')
    Left = 504
    Top = 152
